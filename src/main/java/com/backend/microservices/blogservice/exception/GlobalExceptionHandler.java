...
import com.backend.microservices.blogservice.dto.APIError;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({NoBlogPresentException.class})
    ResponseEntity<Object> NoBlogPresentHandler(Exception exception, ServletWebRequest servletWebRequest){
